...
public class SeriesRowsProperty extends Dialog implements android.view.View.OnClickListener, OnCheckedChangeListener {
	...
	public SeriesRowsProperty(Context context, Chart esChart) {
		super(context);
	...
	public SeriesRowsProperty(Context context, int theme, Chart esChart) {
		super(context, theme);
	...
	public SeriesRowsProperty(Context context, boolean cancelable,
